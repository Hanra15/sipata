                ...
                <form action="" method="post" id="form_tambah" class="form row g-3 needs-validation" enctype="multipart/form-data" novalidate>
                    <div class="col-md-6">
                        ...
                        <div class="form-floating">
                            <input type="text" class="form-control" id="namaFasilitas" name="nama" placeholder="test" required>
                    ...
                    <div class="col-md-6">
                        <div class="form-floating">
                            ...
                            <label for="tanggalBerita" class="col-form-label">Kategori Fasilitas</label>
                            <div class="invalid-feedback">
...
<script>
    $(document).ready(function() {
        ...
        $(".form").submit(function(e) {
            ...
            $.ajax({
                url: "<?= base_url(); ?>fasum/Fasum/tambah",
                method: "POST",
                data: formData,
                dataType: 'JSON',
                contentType: false,
    ...
    function detail(id) {
        $.ajax({
            ...
            success: function(results) {
                ...
                let kategori = data.category_fasum

            ...
            <div class="col-lg-12">
                ...
                <div class="card">
                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-md-6">
                                <div class="d-flex flex-row-reverse">
                                    <a href="<?= base_url() ?>fasum/Fasum/edit_fasum/<?= $data['getDetails']['id'] ?>" class="btn btn-primary mt-3 mb-3 d-flex">
                                        Edit <?= $breadcrumb; ?>
                                    </a>
                        ...
                        <form action="" method="" id="form_detail" class="form row g-3 needs-validation" novalidate>
                            <div class="col-md-6">
                                ...
                                <div class="form-floating">
                                    <input type="text" class="form-control" id="namaFasum" name="nama" placeholder="test" value="<?= $data['getDetails']['name_fasum'] ?>" disabled>
                                    <label for="namaFasum" class="col-form-label">Nama Fasilitas</label>
                            ...
                            <div class="col-md-6">
                                <div class="form-floating mb-3">
                                    <input type="text" class="form-control" id="kategoriFasum" name="kategori" placeholder="test" value="<?= $data['getDetails']['category_fasum']['name_category'] ?>" disabled>
                                    <label for="kategoriFasum" class="col-form-label">Kategori Fasilitas</label>
                                </div>
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <img src="<?= url_api() . $data['getDetails']['image_fasum'] ?>" alt="no-image" class="border border-primary-subtile border-5" style="width: 100%; height:100%">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-12">
                                <div class="form-floating">
                                    <input type="text" class="form-control" id="kontak" name="kontak" placeholder="test" value="<?= $data['getDetails']['contact_fasum'] ?>" disabled>
                    ...
                    <div class="modal-footer">
                        <a href="<?= base_url() ?>fasum" class="btn btn-secondary">Kembali</a>

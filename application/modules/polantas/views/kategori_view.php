    ...
    <div class="pagetitle">
        ...
        <nav>
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="<?= base_url() ?>polantas">Polantas</a></li>
            ...
            <div class="col-lg-12">
                ...
                <div class="card" style="width: 50%;">
                    <div class="card-body">
                        ...
                        <a href="<?= base_url() ?>polantas" class="btn btn-secondary mt-3 mb-3">Kembali</a>
                        <hr class="mt-0">
...
<script>
    $(document).ready(function() {
        ...
        // init fetch data
        var fetchData = fetch("<?= base_url() ?>polantas/Kategori/serverSideTable").then(
        ...
        $(".form").submit(function(e) {
            ...
            $.ajax({
                url: "<?= base_url(); ?>polantas/Kategori/tambah",
                method: "POST",
                data: formData,
                dataType: 'JSON',
                contentType: false,
    ...
    function detail(id) {
        $.ajax({
            url: '<?= base_url() ?>polantas/Kategori/detail',
            type: 'POST',
            data: {
                id_polantas: id
            },
    ...
    $('#btnEdit').on('click', function(e) {
        ...
        // console.log(formData)
        $.ajax({
            url: '<?= base_url() ?>polantas/Kategori/edit',
            type: 'POST',
            data: formData,
            dataType: 'JSON',
            contentType: false,
    ...
    function hapus(id) {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                $.ajax({
                    url: "<?= base_url() ?>polantas/Kategori/hapus",
                    type: "POST",
                    data: {
                        id_kategori: id
                    },

                        ...
                        <form action="" method="post" id="form_edit" class="form row g-3 needs-validation" enctype="multipart/form-data" novalidate>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-floating">
                                    <input type="text" class="form-control" id="namaPolantas" name="nama" placeholder="masukan Nama Polantas" value="<?= $data['getDetails']['name_polantas'] ?>" required>
                                    <label for="namaPolantas" class="col-form-label">Nama CCTV</label>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-floating">
                                    <select class="form-select" name="kategori" id="kategoriPolantas">
                                        <option value="<?= $data['getDetails']['category_polantas']['id'] ?>"><?= $data['getDetails']['category_polantas']['name_category'] ?> (current)</option>
                                        <?php
                                    ...
                                    <label for="kategoriPolantas" class="col-form-label">Kategori Polantas</label>
                                    <div class="invalid-feedback">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="file" class="dropify" id="fotoLokasi" name="image" data-allowed-file-extensions="jpg jpeg png" data-default-file="<?= url_api() . $data['getDetails']['image_polantas'] ?>" data-show-remove="false">
                            ...
                            <div class="col-md-12">
                                <div class="form-floating">
                                    <input type="text" class="form-control" id="kontak" name="kontak" placeholder="test" value="<?= $data['getDetails']['contact_polantas'] ?>" required>
                            ...
                            <div class="modal-footer">
                                <a href="<?= base_url() ?>polantas/Polantas" class="btn btn-secondary">Kembali</a>

    ...
    <div class="pagetitle">
        ...
        <nav>
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="<?= base_url() ?>trayek">Trayek</a></li>
            ...
            <div class="col-lg-12">
                ...
                <div class="card" style="width: 50%;">
                    <div class="card-body">
                        ...
                        <a href="<?= base_url() ?>trayek" class="btn btn-secondary mt-3 mb-3">Kembali</a>
                        <hr class="mt-0">
...
<script>
    $(document).ready(function() {
        ...
        // init fetch data
        var fetchData = fetch("<?= base_url() ?>trayek/Kategori/serverSideTable").then(
        ...
        $(".form").submit(function(e) {
            ...
            $.ajax({
                url: "<?= base_url(); ?>trayek/Kategori/tambah",
                method: "POST",
                data: formData,
                dataType: 'JSON',
                contentType: false,
    ...
    function detail(id) {
        $.ajax({
            url: '<?= base_url() ?>trayek/Kategori/detail',
            type: 'POST',
            data: {
                id_trayek: id
            },
    ...
    $('#btnEdit').on('click', function(e) {
        ...
        // console.log(formData)
        $.ajax({
            url: '<?= base_url() ?>trayek/Kategori/edit',
            type: 'POST',
            data: formData,
            dataType: 'JSON',
            contentType: false,
    ...
    function hapus(id) {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                $.ajax({
                    url: "<?= base_url() ?>trayek/Kategori/hapus",
                    type: "POST",
                    data: {
                        id_kategori: id
                    },

...
class M_trayek extends CI_Model
{
    ...
    public function get_datatables($postData = null)
    {
        ...
        $result = guzzle_request('GET', 'trayek?token=' . $token, []);
        ...
        foreach ($result["data"] as $field) {
            ...
            // $row ['id']	=  $field['id']; 
            $row['No']      =  $no++;
            $row['Nama Trayek']    = $field['name_trayek'];
            $row['Kategori Trayek']   = $field['category_trayek']['name_category'];
            $row['Alamat']    = $field['region'];
            $row['Kontak']    = $field['route'];
            $row['aksi'] = '
                <div class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <li><a class="dropdown-item text-primary" href="' . base_url() . 'trayek/Trayek/detail_trayek/' . $field['id'] . '"><i class="bi bi-eye-fill"></i> Detail</a></li>
                        <li><a class="dropdown-item text-success" href="' . base_url() . 'trayek/Trayek/edit_trayek/' . $field['id'] . '"><i class="bi bi-pencil-square"></i> Edit</a></li>

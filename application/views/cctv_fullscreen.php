...
<body class="toggle-sidebar">
    ...
    <header id="header" class="header fixed-top d-flex align-items-center justify-content-between">
        <a href="<?= base_url() ?>" class="btn btn-secondary d-flex align-items-center">
            <i class="bi bi-arrow-left-circle me-2"></i> Kembali
        </a>



        <a href="<?= base_url() ?>" class="logo d-flex justify-content-center">
            <img src="<?= base_url() ?>assets/img/logo/logo.png" alt="" class="mx-0">
        </a>
